...
# Generated by Powerlevel10k configuration wizard on 2024-04-01 at 11:09 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49778.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, blurred heads, slanted tails, 2 lines, dotted, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context                 # user (local) or user@hostname (remote)
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # context                 # user@hostname (moved to left prompt)
